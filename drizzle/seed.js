...
//     shortLinkTable: schemas.shortLinkTable,
//   },
//   { count: 1 } // default value is 10, but you can customize it.
// ).refine((f) => ({
//   usersTable: {
//     with: {
//       shortLinkTable: 100, // here, I am telling it to create 100 short links for each user.
//     },
//   },
// }));
...
await seed(
  ...
  shortLinkTable: {
    columns: {
      ...
      url: f.default({ defaultValue: "https://www.linkedin.com/in/santu-pramanik-079624322/" }),
    },
  },
}));
process.exit(0);